...
library LibArray {
    ...
    function toSingletonArray(bool self) internal pure returns (bool[] memory arr) {
        arr = toBooleans(toSingletonArray(self ? uint256(1) : 0));
    }

    function toSingletonArray(uint96 self) internal pure returns (uint96[] memory arr) {
    ...
    function lengthen(uint96[] memory self, uint256 length) internal pure returns (uint96[] memory lengthened) {
    ...
    function shorten(uint96[] memory self, uint256 length) internal pure returns (uint96[] memory shortened) {
    ...
    function isEqual(uint96[] memory self, int256[] memory other) internal pure returns (bool yes) {
    ...
    function hasDuplicates(uint96[] memory self) internal pure returns (bool yes) {
    ...
    function sort(uint96[] memory self) internal pure returns (uint96[] memory sorted) {
    ...
    function toAddresses(bytes memory data) internal pure returns (address[] memory addrs) {
        addrs = toAddresses(toUint256s(data));
    }

    function toBytes32s(bytes memory data) internal pure returns (bytes32[] memory bytes32s) {
        bytes32s = toBytes32s(toUint256s(data));
    }

    function toUint256s(bytes memory data) internal pure returns (uint256[] memory uint256s) {
        assembly ("memory-safe") {
    ...
    function toBooleans(uint256[] memory self) internal pure returns (bool[] memory booleans) {
        assembly ("memory-safe") {
            booleans := self
        }
    }

    function toUint96s(uint256[] memory self) internal pure returns (uint96[] memory uint96s) {
        assembly ("memory-safe") {
            uint96s := self
        }
    }
